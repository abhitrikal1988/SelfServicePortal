...
test('Validating Enrollment Application through Broker Portal', async () => {
    ...
    await page.locator('select[name="enrollmentSource"]').selectOption('Broker-Portal');
    ...
    await page.locator('input[formcontrolname="zipCode"]').fill(dataset[1].ZipCode);
    await page.locator("//select[@formcontrolname='planId']").click();
    await page.locator("//select[@formcontrolname='planId']").selectOption(dataset[1].PlanID);
    await page.locator('input[name="appRecDate"]').fill(dataset[1].ApplicationReceivedDate);
    await page.locator('input[formcontrolname="firstName"]').fill(dataset[1].FirstName);
    await page.locator('input[formcontrolname="lastName"]').fill(dataset[1].LastName);
    await page.locator('#DOBpicker').fill(dataset[1].DateofBirth);
    await page.locator('select[formcontrolname="sex"]').click();
    await page.locator('select[formcontrolname="sex"]').selectOption(dataset[1].Gender);
    ...
    await page.locator('input[name="signature"]').fill(dataset[1].Signature);
